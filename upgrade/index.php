...
<header class="mdl-layout__header ben-cherif-color--blue  mdl-layout__header--waterfall">
    <div class="mdl-layout__header-row  ">
        <!-- Title -->
        <span class="mdl-layout-title">Upgrade Process</span>
...
if (isset($_POST['db_server'], $_POST['db_name'], $_POST['db_user_name'], $_POST['db_user_password'], $_POST['db_prefix'])) {
    ...
    if ($connect) {
        ...
        if ($selectDB) {
                ...
                echo '<div class="card-display-error-success  mdl-shadow--2dp "> <div class="mdl-card__title mdl-color-text--white">Your script has been upgraded "if u have any issue contact me "</div></div> ';
            }
...
<div class="ben-cherif--badge--color-green   mdl-shadow--4dp " style="height: 250px;text-align: center">
    ...
    <p class=" mdl-card_installation-description "> Welcome please fill  the information </p>
</div>
