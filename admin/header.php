...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><b>WhatsClone</b>Dashboard</span>
        </a>
    ...
    <aside class="main-sidebar " >
        ...
        <section class="sidebar " >
            ...
            <ul class="sidebar-menu ">
                ...
                <li class="active"><a href="index.php"><i class="fa fa-area-chart"></i> <span>Statistics data</span></a>
                </li>
                <li><a href="users.php?cmd=users"><i class="fa  fa-user"></i> <span>Users</span></a></li>
                <li><a href="groups.php?cmd=groups"><i class="fa  fa-users"></i> <span>Groups</span></a></li>
                <li><a href="messages.php?cmd=messages"><i class="fa  fa-envelope-o"></i> <span>Messages</span></a></li>
