...
class MessagesController
{
    ...
    public function getGroupMessage($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'message', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
    ...
    public function getGroupMessageVideo($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'video', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
            return $fetch['video'];
        } else {
    ...
    public function getGroupMessageVideoThumbnail($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'thumbnail', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
    ...
    public function getGroupMessageImage($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'image', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
            return $fetch['image'];
        } else {
    ...
    public function getGroupMessageAudio($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'audio', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
            return $fetch['audio'];
        } else {
    ...
    public function getGroupMessageDocument($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'document', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
    ...
    public function getGroupMessageDate($messageId, $groupId)
    {
        ...
        $query = $this->_GB->_DB->select('messages', 'Date', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
            return $fetch['Date'];
        } else {
    ...
    /**
     * get file size of group message
     * @param $messageId
     * @param $groupId
     * @return null
     */
    public function getGroupMessageFileSize($messageId, $groupId)
    {

        $messageId = $this->_GB->_DB->escapeString($messageId);
        $groupId = $this->_GB->_DB->escapeString($groupId);

        $query = $this->_GB->_DB->select('messages', 'fileSize', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
            return $fetch['fileSize'];
        } else {
            return null;
        }
    }
    ...
    /**
     * get duration of group message
     * @param $messageId
     * @param $groupId
     * @return null
     */
    public function getGroupMessageDuration($messageId, $groupId)
    {

        $messageId = $this->_GB->_DB->escapeString($messageId);
        $groupId = $this->_GB->_DB->escapeString($groupId);

        $query = $this->_GB->_DB->select('messages', 'duration', " `id`= '{$messageId}' AND  `groupID`= '{$groupId}' ",'',1);
        if ($this->_GB->_DB->numRows($query) != 0) {
            $fetch = $this->_GB->_DB->fetchAssoc($query);
    ...
    public function checkUnsentMessageGroup($array)
    {
        ...
        if ($this->existUnsentMessageGroup($recipientId)) {
            ...
            while ($fetch = $this->_GB->_DB->fetchAssoc($query)) {
                ...
                $fetch['fileSize'] = $this->getGroupMessageFileSize($fetch['messageId'], $fetch['groupId']);
                $fetch['duration'] = $this->getGroupMessageDuration($fetch['messageId'], $fetch['groupId']);
    ...
    public function sendMessageGroup($array)
    {
        ...
        if ($this->existMessage($groupID, $messageId, $senderId, $recipientId)) {
            if ($isSent == 0) return;
            $fields = "`status` = '" . 1 . "'";
